...
class AestheticsPredictor:
    def __init__(self):
        ...
        s = torch.load("/model/WangYanbin/openai/laion-aesthetic-predictor/sac+logos+ava1-l14-linearMSE.pth")
        model.load_state_dict(s)

        model.to(device)
        model.eval()

        clip_model, _ = clip.load("/model/WangYanbin/openai/ViT-L-14.pt", device=device)
